...
const Task = ({text, completed, id, onRemove, onEdit, list, onComplete }) => {
    ...
    return <div key={id} className="tasks_items_row">
        <div className="checkbox">
            ...
            <label htmlFor={`task-${id}`}>
                <svg  width="512" height="512" x="0" y="0"
                      ...
                      className=""><g><path  d="m159.988281 318.582031c-3.988281 4.011719-9.429687 6.25-15.082031 6.25s-11.09375-2.238281-15.082031-6.25l-120.449219-120.46875c-12.5-12.5-12.5-32.769531 0-45.246093l15.082031-15.085938c12.503907-12.5 32.75-12.5 45.25 0l75.199219 75.203125 203.199219-203.203125c12.503906-12.5 32.769531-12.5 45.25 0l15.082031 15.085938c12.5 12.5 12.5 32.765624 0 45.246093zm0 0"
                                             fill="#ffffff" data-original="#000000" className=""/></g>
                </svg>
            </label>
       ...
       <p>{text}</p>
        ...
        <div className="tasks_items_row-actions">
